...
ignored by Git and regenerated by the build.
...
The npm package and release artifacts include generated CSS, but contributors
should commit source and tooling changes rather than generated `dist/` files.
