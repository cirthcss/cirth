...
material allows. It also expresses the project's claim that structure, not
decoration, is what lasts.
...
The Cirth code is released under the MIT License; the name and logo are brand assets with
their own terms:
